...
//=======================delete task and easy to understand but performance is slow ===========================//
...
//           await checkImageExistsInCloudinary(imageUrl);
...
//       for (const imageUrl of images) {
//         const deleteResult = await deleteTaskFromCloudinary(imageUrl);
//         if (!deleteResult) {
//           return res.status(400).json({
//             status: false,
...
//==============================delete task but hard to understand but performance is good========================//

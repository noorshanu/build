  ...
  return (
    <div>
      <div className="flex items-center justify-between pb-1 relative">
        ...
        <div className="flex items-center space-x-2 pr-6 opacity-70 absolute top-0 right-0">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              <div className="grid grid-cols-2 gap-5">
                ...
                >
                  <MdOutlineWorkOutline className="mr-2 w-5 h-5" />
                  <span>Find work</span>
                </Button>
                ...
                >
                  <MdOutlinePersonAddAlt className="mr-2 w-5 h-5" />
            ...
            <div>
              <Typography className="mb-1 flex">
              ...
              <div className="flex space-x-4">
                ...
                <Suspense fallback={<>loading...</>}>
                  <ConnectWalletButton className="whitespace-nowrap">
                    Connect Wallet
                  </ConnectWalletButton>
                </Suspense>
              </div>

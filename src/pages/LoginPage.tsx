...
function LoginPage() {
  ...
  return (
    <>
      <div>
        {error && (
          <div className="bg-red-500 text-white p-3 rounded mb-5">{error}</div>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <Typography
            asChild
            className="text-green-haze-600 underline w-fit block"
          >
      ...
      <div className="flex justify-center items-center mx-auto mt-4 gap-3">
        <SocialAuthIcon>
          <FaFacebook />
        </SocialAuthIcon>
